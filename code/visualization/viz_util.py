...
#         pdb.set_trace()
    ...
    if text:
        plt_fig.text(0.5, 0.2, text, fontsize=18,  wrap=True, horizontalalignment='center',
                     verticalalignment='center', transform=plt_fig.transFigure)
...
###----------------------------------------###
###  Visualization same with sanity check  ###
###----------------------------------------###
